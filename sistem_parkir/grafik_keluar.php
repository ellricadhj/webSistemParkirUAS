...
include'koneksi.php';
	...
	$tahun = date("Y");
$a = array();
echo "<h1>Grafik Parkir Keluar per Tahun ".$tahun."</h1>";
for ($i=1; $i <=12 ; $i++) {
  // Select Banyak Id pada Tabel Iklan dimana bulan pada kolom Tanggal = $i dan Tahun pada kolom Tanggal = $tahun
  $sql = "select count('id') as jumlah from parkir_keluar where (month(waktu_keluar)=$i and year(waktu_keluar)='$tahun')";
